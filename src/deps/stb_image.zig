...
pub const struct__IO_marker = opaque {}; // /usr/include/bits/types/struct_FILE.h:74:7: warning: struct demoted to opaque type - has bitfield
pub const struct__IO_FILE = opaque {
    ...
    pub const stbi_load_from_file = __root.stbi_load_from_file;
    pub const stbi_load_from_file_16 = __root.stbi_load_from_file_16;
    pub const stbi_loadf_from_file = __root.stbi_loadf_from_file;
    pub const stbi_is_hdr_from_file = __root.stbi_is_hdr_from_file;
    pub const stbi_info_from_file = __root.stbi_info_from_file;
    pub const stbi_is_16_bit_from_file = __root.stbi_is_16_bit_from_file;
    pub const unlocked = __root.fflush_unlocked;
    pub const uflow = __root.__uflow;
    pub const overflow = __root.__overflow;
    pub const file = __root.stbi_load_from_file;
    pub const @"16" = __root.stbi_load_from_file_16;
};
...
pub const stbi_io_callbacks = extern struct {
    read: ?*const fn (user: ?*anyopaque, data: [*c]u8, size: c_int) callconv(.c) c_int = null,
    skip: ?*const fn (user: ?*anyopaque, n: c_int) callconv(.c) void = null,
    eof: ?*const fn (user: ?*anyopaque) callconv(.c) c_int = null,
    pub const stbi_load_from_callbacks = __root.stbi_load_from_callbacks;
    pub const stbi_load_16_from_callbacks = __root.stbi_load_16_from_callbacks;
    pub const stbi_loadf_from_callbacks = __root.stbi_loadf_from_callbacks;
    pub const stbi_is_hdr_from_callbacks = __root.stbi_is_hdr_from_callbacks;
    pub const stbi_info_from_callbacks = __root.stbi_info_from_callbacks;
    pub const stbi_is_16_bit_from_callbacks = __root.stbi_is_16_bit_from_callbacks;
    pub const callbacks = __root.stbi_load_from_callbacks;
};
...
pub const __getc_unlocked_body = @compileError("TODO postfix inc/dec expr"); // /usr/include/bits/types/struct_FILE.h:105:9
pub const __putc_unlocked_body = @compileError("TODO postfix inc/dec expr"); // /usr/include/bits/types/struct_FILE.h:109:9
...
pub const STBIDEF = @compileError("unable to translate C expr: unexpected token 'extern'"); // ./deps/stb_image.h:398:9
